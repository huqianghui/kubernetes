...
public class KubernetesDiscoveryClient implements DiscoveryClient {
    ...
    public List<ServiceInstance> getInstances(String serviceId) {
        ...
        System.out.println("***endpoint:" + this.client.endpoints());
        System.out.println("***endpointsList:" + this.client.endpoints().withName(serviceId).get());
    ...
    private Map<String, String> getServiceMetadata(Service service) {
        ...
        System.out.println("***serviceMetadata:" + serviceMetadata);
